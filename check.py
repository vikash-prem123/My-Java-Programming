...
Bot1_X, Bot1_Y = random.randint(0,N-1), random.randint(0,N-1) # Position of the first bot (Player1): Hackathon participants may change it to suitable values to test their codes 
